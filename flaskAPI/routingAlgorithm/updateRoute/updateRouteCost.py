...
class RouteCost:
    ...
    def update_route_cost_in_data_base(self, service_type):
        ...
        for link_data in self.link_versions:
            ...
            ### tinh toan link cost 
            link_cost = self.calculate_link_cost(delay, packet_loss, link_utilization, service_type)
    ...
    def calculate_link_cost_serivce_1(self, link_delay, link_loss, link_utilization, service_type):
        """
