...
class generate_topo_info:
    def __init__(self):
        self.list_ip = json.load(open('/home/onos/Downloads/flaskSDN/flaskAPI/set_up/set_up_topo.json'))["controllers"]
        self.topo_network  = ''
        self.hosts  = ''
        self.servers  = ''
        self.graph = ''
...
# net = run_final.run_params.net
# hosts_save = run_final.run_params.hosts_save

# print(run_final.nodes_graph)

# generate_topo(net, hosts_save)